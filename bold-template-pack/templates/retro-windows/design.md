...
Then append `'Noto Sans SC'` to the body fontFamily token in the inline tailwind.config:
```js
fontFamily: {
  body: "'MS Sans Serif', 'Segoe UI', Tahoma, Geneva, Verdana, 'Noto Sans SC', sans-serif",
}
```
