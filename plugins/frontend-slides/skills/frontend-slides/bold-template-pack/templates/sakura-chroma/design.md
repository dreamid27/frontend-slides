...
Then append the CJK families to the matching fontFamily tokens in the inline tailwind.config:
```js
fontFamily: {
  display: "'Big Shoulders Display', 'ZCOOL XiaoWei', sans-serif",
  body:    "'Albert Sans', 'LXGW WenKai', sans-serif",              // body / micro roles
  mono:    "'JetBrains Mono', 'LXGW WenKai', ui-monospace, monospace", // if used for CJK content
}
```
